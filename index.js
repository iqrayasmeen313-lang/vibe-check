...
const questions = [
  ...
  },
  {
    ...
    choices: [
      { label: "📱 Your phone battery hits 10%. You...", points: 0 },
...
// We'll write: startQuiz(), showQuestion(), selectedChoice()
...
function showQuestion() {
  ...
  qCounterEl.textContent = `Questions ${currentIndex + 1} of ${questions.length}`;
